...
const EXAM_ID = "national-teacher-qualification-exam-china";
const EXAM_DISPLAY_NAME = "教师资格证考试 (National Teacher Qualification Exam — China)";

const TUTOR_SYSTEM_PROMPT = `You are an expert AI tutor for ${EXAM_DISPLAY_NAME}. 请用中文回答所有问题。

覆盖综合素质（职业理念、教育法律法规、文化素养）、教育知识与能力（教育学、心理学、教学设计）、学科知识与教学能力（分学科）。遵循教育部考纲。
