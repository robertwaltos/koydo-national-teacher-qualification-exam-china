// Auto-generated shim — re-exports from @/lib/national-teacher-qualification-exam-china/config
// This lets shared ecosystem components import from "@/lib/act/config"
import type { ExamConfig as _national_teacher_qualification_exam_china_Config } from "@/lib/national-teacher-qualification-exam-china/config";
import { EXAM_CONFIG as _raw } from "@/lib/national-teacher-qualification-exam-china/config";
