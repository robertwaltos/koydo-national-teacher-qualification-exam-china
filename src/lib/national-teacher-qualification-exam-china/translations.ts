// National Teacher Qualification Exam China UI Translations

export const TRANSLATIONS = {
  en: {
    hero_title: "Ace National Teacher Qualification Exam China with confidence",
  ...
  "zh-CN": {
    hero_title: "National Teacher Qualification Exam China — prepare with Koydo",
